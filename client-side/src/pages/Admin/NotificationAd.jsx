...
const NotificationAd = ({ userId }) => {
  ...
  const { data } = useQuery({
    queryKey: ["mark-all-read", "Manager"],
    queryFn: () => markAllRead_ad_Reci("Manager"),
  });
  ...
  return (
    <div className="">
      <div className="flex justify-between items-center mb-2 bg-white shadow-lg px-10 py-4 sticky top-0">
