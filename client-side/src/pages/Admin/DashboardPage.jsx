...
import UserChart from "./inside/component.jsx/UserChart";
...
const DashboardPage = () => {
  ...
  const rooms = [
    { number: 101, status: "occupied", cleaning: "clean" },
    { number: 102, status: "vacant", cleaning: "needs-cleaning" },
    { number: 103, status: "occupied", cleaning: "in-progress" },
  ];
